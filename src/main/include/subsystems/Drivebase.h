...
private:
    ...
    rev::CANSparkMax dbLF{leftFollowDeviceID,rev::CANSparkMaxLowLevel::MotorType::kBrushless};

    rev::CANSparkMax dbR{rightLeadDeviceID,rev::CANSparkMaxLowLevel::MotorType::kBrushless};
    rev::CANSparkMax dbRF{rightFollowDeviceID,rev::CANSparkMaxLowLevel::MotorType::kBrushless};
